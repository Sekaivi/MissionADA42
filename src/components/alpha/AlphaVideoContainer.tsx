        ...
        >
            ...
            {qrMountRef && (
                <div
                    ...
                    className={clsx(
                        'h-full w-full overflow-hidden [&_video]:!h-full [&_video]:!w-full [&_video]:!object-cover [&_video]:transition-transform [&_video]:duration-300',
                        isMirrored && '[&_video]:scale-x-[-1]'
                    )}
                />
            )}
