...
export default function PasswordGame({ onSolve }: PasswordGameProps) {
    // --- STATE ---
    ...
    return (
        <div className="bg-background text-foreground selection:bg-brand-emerald flex w-full flex-col items-center justify-center p-4 font-mono selection:text-black">
