        ...
        <div className="h-[90dvh]">
            ...
            {gameState === 'playing' && (
                <div className="flex h-full flex-1 flex-col gap-6">
                    <div
                        ref={containerRef}
                        className="border-brand-emerald relative h-full w-full max-w-4xl flex-1 overflow-hidden rounded-lg border-2 bg-black/80 shadow-[0_0_20px_rgba(0,212,146,0.2)]"
                    >
